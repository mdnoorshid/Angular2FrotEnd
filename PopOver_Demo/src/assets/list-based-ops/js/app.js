...
(function($){
  $(window).on("load",function(){
    $(".js-content-dropdown").mCustomScrollbar();
    $(".js-app-sidebar").mCustomScrollbar();
    $('.js-selectpicker').selectpicker({
      style: 'btn-select-field',
      size: 4
    });
    $('body').click(function() {
     //$('.js-btn-group-setting').removeClass("open");
    });
    $(".js-btn-setting").click(function() {
     // $('.js-btn-group-setting').toggleClass("open");
    });
    $(".js-btn-download").click(function() {
     $('.js-btn-group-setting').removeClass("open");
    });
    $(".js-btn-add-more").click(function() {
     $('.js-add-more').addClass("show");
      var inpTxt = $('#inpTxt').val();
      var fieldsSel = $('#fieldsSel').val();
      var equalsSel = $('#equalsSel').val();
      var html = '<div class="wrapper-add-more-search-value js-wrapper-add-more-search-value"><span class="fieldValSel">'+fieldsSel+'</span><span class="equalsValSel equal-sign">'+equalsSel+'</span><span class="inpValTxt">'+inpTxt+'</span><div class="close js-add-more-close">&times;</div></div>';
      $('#resultsBox').append(html);

    });
    $('body').on('click', '.js-wrapper-add-more-search-value .js-add-more-close', function () {
      $(this).closest('.js-wrapper-add-more-search-value').remove();
    });
    $(".js-btn-close-add-more").click(function() {
     $('.js-add-more').removeClass("show");
    });
    $('body').on('click', '.js-content-add-more .js-btn-close-add-more', function () {
      $('.js-wrapper-add-more-search-value').remove();
    });
    $(".js-btn-add-more-xs").click(function() {
     $('.js-add-more-xs').addClass("show");
      var inpTxt = $('#inpTxt-xs').val();
      var fieldsSel = $('#fieldsSel-xs').val();
      var equalsSel = $('#equalsSel-xs').val();
      var html = '<div class="wrapper-add-more-search-value js-wrapper-add-more-search-value-xs"><span class="fieldValSel">'+fieldsSel+'</span><span class="equalsValSel equal-sign">'+equalsSel+'</span><span class="inpValTxt">'+inpTxt+'</span><div class="close js-add-more-close-xs">&times;</div></div>';
      $('#resultsBox-xs').append(html);

    });
    $('body').on('click', '.js-wrapper-add-more-search-value-xs .js-add-more-close-xs', function () {
      $(this).closest('.js-wrapper-add-more-search-value-xs').remove();
    });
    $(".js-btn-close-add-more-xs").click(function() {
     $('.js-add-more-xs').removeClass("show");
    });
    $(".js-open-filter-xs").click(function() {
     $('.row-filters').addClass("open");
     $('.col-left').removeClass("hidden");
     $('.col-right').addClass("hidden-xs");
     // $('.js-add-more').addClass("open");
     // $('this').addClass('fade-out');
    });
    $(".js-open-buttons-xs").click(function() {
     $('.row-filters').addClass("open");
     $('.col-left').addClass("hidden");
     $('.col-right').removeClass("hidden-xs");
     $('.js-add-more').removeClass("open");
     // $('this').addClass('fade-out');
    });
    $(".js-close-filter-xs").click(function() {
     $('.row-filters').removeClass("open");
     $('.js-add-more').removeClass("show");
     // $('this').addClass('fade-out');
    });
    $('body').on('click', '.js-content-add-more-xs .js-btn-close-add-more-xs', function () {
      $('.js-wrapper-add-more-search-value-xs').remove();
    });
    $(".js-select-add-more-filter").select2({
      placeholder: "Select More Filter"
    });
    $(".js-select-set-time").select2({
      placeholder: "Select Time"
    });
    $(".js-select").select2({
      //placeholder: "Select Printer"
    });
    //$('.js-data-table-listing').DataTable();
    $('.js-data-table-listing').DataTable( {
        //"paging":   false,
        //"ordering": false,
        //"info":     false
    ...
    $(".js-icon-quick-access-1").click(function() {
      $('.js-col-details-quick-access-1 .js-quick-access-data').toggleClass("show");
      $(this).toggleClass("collapsed");
    });
    $(".js-icon-quick-access-2").click(function() {
      $('.js-col-details-quick-access-2 .js-quick-access-data').toggleClass("show");
      $(this).toggleClass("collapsed");
    });
    $(".js-icon-quick-access-3").click(function() {
      $('.js-col-details-quick-access-3 .js-quick-access-data').toggleClass("show");
      $(this).toggleClass("collapsed");
    });
    $(".js-icon-quick-access-4").click(function() {
      $('.js-col-details-quick-access-4 .js-quick-access-data').toggleClass("show");
      $(this).toggleClass("collapsed");
    });
    $(".js-icon-quick-access-5").click(function() {
      $('.js-col-details-quick-access-5 .js-quick-access-data').toggleClass("show");
      $(this).toggleClass("collapsed");
    });
    $(".js-icon-quick-access-6").click(function() {
      $('.js-col-details-quick-access-6 .js-quick-access-data').toggleClass("show");
      $(this).toggleClass("collapsed");
    });
    $(".js-icon-quick-access-7").click(function() {
      $('.js-col-details-quick-access-7 .js-quick-access-data').toggleClass("show");
      $(this).toggleClass("collapsed");
    });

    $(".js-icon-quick-access-8").click(function() {
      $('.js-col-details-quick-access-8 .js-quick-access-data').toggleClass("show");
      $(this).toggleClass("collapsed");
    });
...
$(document).ready(function (){
   ...
   var rows_selected = [];
   var selected = [];
   var table = $('.js-data-table-listing-based-operation').DataTable({
      "bFilter": true,
      "bPaginate": false,
      "sDom": '<"top"flp>r<"table-scrollable"t><"bottom"i<"button">><"clear">',
      // "responsive": true,
      'columnDefs': [{
         'targets': 0,
         'searchable':false,
  ...
  $('.js-data-table-listing-based-operation tbody').on('click', 'tr', function () {
        var id = this.id;
        ...
        $('.js-data-table-listing-based-operation tbody tr').removeClass('selected-row');
        $(this).toggleClass('selected-row');
    } );

   // Handle click on checkbox
   $('.js-data-table-listing tbody').on('click', 'input[type="checkbox"]', function(e){
   ...
   $('.js-data-table-listing').on('click', 'tbody td, thead th:first-child', function(e){
...
$(document).ready(function() {
  function format(value) {
    return '<div class="col-details-quick-access"><div class="quick-access-data"><div class="col-sm-6"><ul class="dtr-details"><li><span class="dtr-title">Item # :</span> <span class="dtr-data">San Diego</span></li><li><span class="dtr-title">Location :</span> <span class="dtr-data">343478</span></li><li><span class="dtr-title">On-Hand Qty :</span> <span class="dtr-data">2636</span></li><li><span class="dtr-title">Available Qty :</span> <span class="dtr-data">A</span></li></ul></div><div class="col-sm-6"><ul class="dtr-details"><li><span class="dtr-title">Inv. Status :</span> <span class="dtr-data">San Diego</span></li><li><span class="dtr-title">Allow Location :</span> <span class="dtr-data">Yes</span></li><li><span class="dtr-title">Pickable  :</span> <span class="dtr-data">No</span></li><li><span class="dtr-title">Date :</span> <span class="dtr-data">2017-03-03</span></li></ul></div></div></div>';
  }
  $(document).ready(function () {
      var table = $('.js-data-table-listing-another').DataTable({
        "bFilter": true,
        "bPaginate": false,
        "sDom": '<"top"flp>rt<"bottom"i<"button">><"clear">'        
      });
      $("div.button").html('<button class="btn btn-primary">More</button>');

      // Add event listener for opening and closing details
      $('.js-data-table-listing-another').on('click', 'td.details-control', function () {
          ...
          if (row.child.isShown()) {
              ...
              // Open this row
              row.child(format(tr.data('child-value')),'child-row').show();
              tr.addClass('shown');
          }
      });
  });
  ...
  $(document).ready(function () {
    ...
    $('.js-contacts').selectize({
      // options: [
      //   {email: 'nikola@tesla.com', first_name: 'Nikola', last_name: 'Tesla', make: 'single', name: 'Avenger'},
      //   {email: 'brian@thirdroute.com', first_name: 'Brian', last_name: 'Reavis', make: 'group', name: 'Brian'},
      // ],
      // optgroups: [
      ...
      // optgroupValueField: 'email',
      // optgroupOrder: ['group', 'single'],
      ...
      valueField: 'email',
      labelField: 'name',
      optgroupField: 'user_group',
      optgroupLabelField: 'name',
      optgroupValueField: 'id',
      optgroupOrder: ['single', 'team'],
      searchField: ['first_name', 'last_name', 'email'],
      sortField: [
        {field: 'first_name', direction: 'asc'},
        {field: 'last_name', direction: 'asc'}
      ...
      options: [
        {email: 'nikola@tesla.com', user_group: 'team', first_name: 'Nikola', last_name: 'Tesla'},
        {email: 'brian@thirdroute.com', user_group: 'single', first_name: 'Brian', last_name: 'Reavis'},
        {email: 'someone@gmail.com', user_group: 'single', first_name: 'Someone', last_name: ''}
      ],
      optgroups: [
        {id: 'team', name: 'Team'},
        {id: 'single', name: 'Single'}
      ...
      render: {
        item: function(item, escape) {
          ...
          var user_group = "";
          return '<div>' +
            (user_group ? '<span class="user_group">' + escape(user_group) + '</span>' : '') +
        ...
        option: function(item, escape) {
          var name = formatName(item);
          var user_group = user_group || item.user_group;
          var label = name || item.email;
          var caption = name ? item.email : null;
          return '<div class="' + (user_group) + '">' +
            '<i class="fa fa-user single-icon"></i><i class="fa fa-users team-icon"></i><span class="label">' + escape(label) + '</span>' +
            (caption ? '' : '') +
          '</div>';
        }
      },
